/*
 * This file implements minimax for the game Dots and Boxes.
 * 
 * Dots and Boxes is a two player game in which players take turns to add 
 * horizontal or vertical lines between two dots in a rectangular grid. If a 
 * line completes a square then the player adding the line owns the square. The
 * aim of the game is to complete as many squares as possible. 
 * 
 * For a more complete description, see: 
 * http://en.wikipedia.org/w/index.php?title=Dots_and_Boxes&oldid=403088056
 * 
 * This file itself is not intended to be an interactive game, rather it is 
 * intended to be called from another program via the main/5 predicate. A text
 * based game implemented in Java which calls this file to make move decisions
 * accompanies this code.
 *
 * @author Hal Blackburn (u0661162)
 */
